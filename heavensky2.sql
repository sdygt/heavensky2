...
INSERT INTO `hs2_comments` (`id`, `post_table`, `post_id`, `url`, `uid`, `to_uid`, `full_name`, `email`, `createtime`, `content`, `type`, `parentid`, `path`, `status`) VALUES
(1, 'posts', 1, 'article/index/id/1', 1, 0, 'admin', 'sdygt@users.noreply.github.com', '2016-01-25 23:57:50', 'nicopoiduang', 1, 0, '0-1', 1),
(2, 'posts', 1, 'article/index/id/1', 3, 0, 'admin', 'admin@sdygt.net', '2016-01-25 23:59:43', '床前明月光', 1, 0, '0-2', 1);
...
INSERT INTO `hs2_common_action_log` (`id`, `user`, `object`, `action`, `count`, `last_time`, `ip`) VALUES
(1, 1, 'posts1', 'Portal-Article-do_like', 1, 1453737394, '0.0.0.0'),
(2, 3, 'posts1', 'Portal-Article-do_like', 23, 1453737612, '0.0.0.0'),
(3, 3, 'posts2', 'Portal-Article-do_like', 1, 1453745942, '0.0.0.0');
...
(2, 'admin', NULL, 1, '二级内容管理员', 1453737007, 1453737027, 0);
...
INSERT INTO `hs2_role_user` (`role_id`, `user_id`) VALUES
(2, 3);
...
(3, '人物详情', '', 'article', '', 0, 0, '0-3', '', '', '', 'list', 'person', 0, 1);
...
INSERT INTO `hs2_user_favorites` (`id`, `uid`, `title`, `url`, `description`, `table`, `object_id`, `createtime`) VALUES
(1, 3, 'First Article', '/heavensky2/article/index/id/1', NULL, 'posts', 1, 1453737613);
