...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-01-18 15:07:48
-- 服务器版本： 5.6.20
-- PHP Version: 5.6.3
...
-- Database: `heavensky2`
--
CREATE DATABASE IF NOT EXISTS `heavensky2` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `heavensky2`;
...
CREATE TABLE IF NOT EXISTS `hs2_ad` (
...
CREATE TABLE IF NOT EXISTS `hs2_asset` (
...
--
-- 表的结构 `hs2_auth_access`
--

CREATE TABLE IF NOT EXISTS `hs2_auth_access` (
...
CREATE TABLE IF NOT EXISTS `hs2_auth_rule` (
...
INSERT INTO `hs2_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
CREATE TABLE IF NOT EXISTS `hs2_comments` (
...
--
-- 表的结构 `hs2_common_action_log`
--

CREATE TABLE IF NOT EXISTS `hs2_common_action_log` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs2_guestbook` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs2_links` (
...
INSERT INTO `hs2_links` (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_description`, `link_status`, `link_rating`, `link_rel`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `hs2_menu` (
...
INSERT INTO `hs2_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `hs2_nav` (
  `id` int(11) NOT NULL,
...
INSERT INTO `hs2_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
...
CREATE TABLE IF NOT EXISTS `hs2_nav_cat` (
...
INSERT INTO `hs2_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
(1, '主导航', 1, '主导航');
...
CREATE TABLE IF NOT EXISTS `hs2_oauth_user` (
  `id` int(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs2_options` (
...
INSERT INTO `hs2_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
...
(2, 'site_options', '            {\n            		"site_name":"忆天堂",\n            		"site_host":"http://localhost/",\n            		"site_root":"",\n            		"site_icp":"",\n            		"site_admin_email":"sdygt@users.noreply.github.com",\n            		"site_tongji":"",\n            		"site_copyright":"",\n            		"site_seo_title":"忆天堂",\n            		"site_seo_keywords":"",\n            		"site_seo_description":""\n        }', 1);
...
CREATE TABLE IF NOT EXISTS `hs2_plugins` (
...
CREATE TABLE IF NOT EXISTS `hs2_posts` (
  `id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs2_role` (
...
INSERT INTO `hs2_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `hs2_role_user` (
...
CREATE TABLE IF NOT EXISTS `hs2_route` (
...
CREATE TABLE IF NOT EXISTS `hs2_slide` (
...
CREATE TABLE IF NOT EXISTS `hs2_slide_cat` (
  `cid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs2_terms` (
...
INSERT INTO `hs2_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
...
--
-- 表的结构 `hs2_term_relationships`
--

CREATE TABLE IF NOT EXISTS `hs2_term_relationships` (
...
CREATE TABLE IF NOT EXISTS `hs2_users` (
  `id` bigint(20) unsigned NOT NULL,
...
(1, 'root', '###34d5358c4408bbe545a9e061fbf36a1d', 'admin', 'sdygt@users.noreply.github.com', '', NULL, 0, NULL, NULL, '0.0.0.0', '2016-01-18 22:00:47', '2016-01-18 09:59:11', '', 1, 0, 1, 0, '');

-- --------------------------------------------------------

--
-- 表的结构 `hs2_user_favorites`
--

CREATE TABLE IF NOT EXISTS `hs2_user_favorites` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `hs2_asset`
--
ALTER TABLE `hs2_asset`
  ADD PRIMARY KEY (`aid`);

--
-- Indexes for table `hs2_auth_access`
--
ALTER TABLE `hs2_auth_access`
  ADD KEY `role_id` (`role_id`),
  ADD KEY `rule_name` (`rule_name`) USING BTREE;

--
-- Indexes for table `hs2_auth_rule`
--
ALTER TABLE `hs2_auth_rule`
  ADD PRIMARY KEY (`id`),
  ADD KEY `module` (`module`,`status`,`type`);

--
-- Indexes for table `hs2_comments`
--
ALTER TABLE `hs2_comments`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `hs2_common_action_log`
--
ALTER TABLE `hs2_common_action_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_object_action` (`user`,`object`,`action`),
  ADD KEY `user_object_action_ip` (`user`,`object`,`action`,`ip`);

--
-- Indexes for table `hs2_guestbook`
--
ALTER TABLE `hs2_guestbook`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hs2_links`
--
ALTER TABLE `hs2_links`
  ADD PRIMARY KEY (`link_id`),
  ADD KEY `link_visible` (`link_status`);

--
-- Indexes for table `hs2_menu`
--
ALTER TABLE `hs2_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `hs2_nav`
--
ALTER TABLE `hs2_nav`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hs2_nav_cat`
--
ALTER TABLE `hs2_nav_cat`
  ADD PRIMARY KEY (`navcid`);

--
-- Indexes for table `hs2_oauth_user`
--
ALTER TABLE `hs2_oauth_user`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hs2_options`
--
ALTER TABLE `hs2_options`
  ADD PRIMARY KEY (`option_id`),
  ADD UNIQUE KEY `option_name` (`option_name`);

--
-- Indexes for table `hs2_plugins`
--
ALTER TABLE `hs2_plugins`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hs2_posts`
--
...
--
-- Indexes for table `hs2_role`
--
ALTER TABLE `hs2_role`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parentId` (`pid`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `hs2_role_user`
--
ALTER TABLE `hs2_role_user`
  ADD KEY `group_id` (`role_id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `hs2_route`
--
ALTER TABLE `hs2_route`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hs2_slide`
--
ALTER TABLE `hs2_slide`
  ADD PRIMARY KEY (`slide_id`),
  ADD KEY `slide_cid` (`slide_cid`);

--
-- Indexes for table `hs2_slide_cat`
--
ALTER TABLE `hs2_slide_cat`
  ADD PRIMARY KEY (`cid`),
  ADD KEY `cat_idname` (`cat_idname`);

--
-- Indexes for table `hs2_terms`
--
ALTER TABLE `hs2_terms`
  ADD PRIMARY KEY (`term_id`);

--
-- Indexes for table `hs2_term_relationships`
--
...
--
-- Indexes for table `hs2_users`
--
ALTER TABLE `hs2_users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_login_key` (`user_login`),
  ADD KEY `user_nicename` (`user_nicename`);

--
-- Indexes for table `hs2_user_favorites`
--
...
--
-- AUTO_INCREMENT for table `hs2_route`
--
ALTER TABLE `hs2_route`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '路由id';
--
-- AUTO_INCREMENT for table `hs2_slide`
--
ALTER TABLE `hs2_slide`
  MODIFY `slide_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `hs2_slide_cat`
--
ALTER TABLE `hs2_slide_cat`
  MODIFY `cid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `hs2_terms`
--
ALTER TABLE `hs2_terms`
