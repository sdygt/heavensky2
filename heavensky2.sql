...
-- 导出 heavensky2 的数据库结构
CREATE DATABASE IF NOT EXISTS `heavensky2` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `heavensky2`;


-- 导出  表 heavensky2.hs2_ad 结构
...
-- 正在导出表  heavensky2.hs2_ad 的数据：0 rows
/*!40000 ALTER TABLE `hs2_ad` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_ad` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_asset 结构
...
-- 正在导出表  heavensky2.hs2_asset 的数据：0 rows
/*!40000 ALTER TABLE `hs2_asset` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_asset` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_auth_access 结构
...
-- 正在导出表  heavensky2.hs2_auth_access 的数据：50 rows
/*!40000 ALTER TABLE `hs2_auth_access` DISABLE KEYS */;
INSERT INTO `hs2_auth_access` (`role_id`, `rule_name`, `type`) VALUES
...
/*!40000 ALTER TABLE `hs2_auth_access` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_auth_rule 结构
...
-- 正在导出表  heavensky2.hs2_auth_rule 的数据：161 rows
/*!40000 ALTER TABLE `hs2_auth_rule` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `hs2_auth_rule` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_comments 结构
...
-- 正在导出表  heavensky2.hs2_comments 的数据：2 rows
/*!40000 ALTER TABLE `hs2_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_comments` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_common_action_log 结构
...
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='访问记录表';

-- 正在导出表  heavensky2.hs2_common_action_log 的数据：9 rows
/*!40000 ALTER TABLE `hs2_common_action_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_common_action_log` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_guestbook 结构
...
-- 正在导出表  heavensky2.hs2_guestbook 的数据：0 rows
/*!40000 ALTER TABLE `hs2_guestbook` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_guestbook` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_links 结构
...
-- 正在导出表  heavensky2.hs2_links 的数据：1 rows
/*!40000 ALTER TABLE `hs2_links` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `hs2_links` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_menu 结构
...
-- 正在导出表  heavensky2.hs2_menu 的数据：161 rows
/*!40000 ALTER TABLE `hs2_menu` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `hs2_menu` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_nav 结构
...
-- 正在导出表  heavensky2.hs2_nav 的数据：4 rows
/*!40000 ALTER TABLE `hs2_nav` DISABLE KEYS */;
INSERT INTO `hs2_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
	...
	(4, 1, 0, 'person', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"3";}}', '', 1, 0, '0-4');
/*!40000 ALTER TABLE `hs2_nav` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_nav_cat 结构
...
-- 正在导出表  heavensky2.hs2_nav_cat 的数据：1 rows
/*!40000 ALTER TABLE `hs2_nav_cat` DISABLE KEYS */;
INSERT INTO `hs2_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
	(1, '主导航', 1, '主导航');
/*!40000 ALTER TABLE `hs2_nav_cat` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_oauth_user 结构
...
-- 正在导出表  heavensky2.hs2_oauth_user 的数据：0 rows
/*!40000 ALTER TABLE `hs2_oauth_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_oauth_user` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_options 结构
...
-- 正在导出表  heavensky2.hs2_options 的数据：3 rows
/*!40000 ALTER TABLE `hs2_options` DISABLE KEYS */;
INSERT INTO `hs2_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
	...
	(2, 'site_options', '{"site_name":"\\u5fc6\\u5929\\u5802","site_host":"http:\\/\\/localhost\\/","site_admin_url_password":"","site_tpl":"simplebootx","mobile_tpl_enabled":"1","site_adminstyle":"flat","site_icp":"","site_admin_email":"sdygt@users.noreply.github.com","site_tongji":"","site_copyright":"","site_seo_title":"\\u5fc6\\u5929\\u5802","site_seo_keywords":"","site_seo_description":"","urlmode":"2","html_suffix":"","comment_time_interval":60}', 1),
	(3, 'cmf_settings', '{"banned_usernames":""}', 1);
/*!40000 ALTER TABLE `hs2_options` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_plugins 结构
...
-- 正在导出表  heavensky2.hs2_plugins 的数据：0 rows
/*!40000 ALTER TABLE `hs2_plugins` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_plugins` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_posts 结构
CREATE TABLE IF NOT EXISTS `hs2_posts` (
  ...
  `post_region` text COMMENT 'post所属地区，为region表中的地区码',
  `post_diedate` date DEFAULT NULL COMMENT '逝世日期',
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='Portal文章表';

-- 正在导出表  heavensky2.hs2_posts 的数据：~13 rows (大约)
/*!40000 ALTER TABLE `hs2_posts` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_posts` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_region 结构
CREATE TABLE IF NOT EXISTS `hs2_region` (
...
-- 正在导出表  heavensky2.hs2_region 的数据：~3,513 rows (大约)
/*!40000 ALTER TABLE `hs2_region` DISABLE KEYS */;
INSERT INTO `hs2_region` (`id`, `parent_id`, `name`) VALUES
	...
	(469023, 469000, '澄迈县'),
	(469024, 469000, '临高县'),
	(469025, 469000, '白沙黎族自治县'),
	(469026, 469000, '昌江黎族自治县'),
	(469027, 469000, '乐东黎族自治县'),
	(469028, 469000, '陵水黎族自治县'),
	(469029, 469000, '保亭黎族苗族自治县'),
	(469030, 469000, '琼中黎族苗族自治县'),
	(500000, 0, '重庆市'),
	(500100, 500000, '市辖区'),
	(500101, 500100, '万州区'),
	(500102, 500100, '涪陵区'),
	...
	(500237, 500200, '巫山县'),
	(500238, 500200, '巫溪县'),
	(500240, 500200, '石柱土家族自治县'),
	(500241, 500200, '秀山土家族苗族自治县'),
	(500242, 500200, '酉阳土家族苗族自治县'),
	(500243, 500200, '彭水苗族土家族自治县'),
	(510000, 0, '四川省'),
	(510100, 510000, '成都市'),
	(510101, 510100, '市辖区'),
	(510104, 510100, '锦江区'),
	...
	(810000, 0, '香港特别行政区'),
	(820000, 0, '澳门特别行政区');
/*!40000 ALTER TABLE `hs2_region` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_role 结构
...
-- 正在导出表  heavensky2.hs2_role 的数据：3 rows
/*!40000 ALTER TABLE `hs2_role` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `hs2_role` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_role_user 结构
...
-- 正在导出表  heavensky2.hs2_role_user 的数据：2 rows
/*!40000 ALTER TABLE `hs2_role_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_role_user` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_route 结构
...
-- 正在导出表  heavensky2.hs2_route 的数据：0 rows
/*!40000 ALTER TABLE `hs2_route` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_route` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_slide 结构
...
-- 正在导出表  heavensky2.hs2_slide 的数据：0 rows
/*!40000 ALTER TABLE `hs2_slide` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_slide` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_slide_cat 结构
...
-- 正在导出表  heavensky2.hs2_slide_cat 的数据：0 rows
/*!40000 ALTER TABLE `hs2_slide_cat` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_slide_cat` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_terms 结构
...
-- 正在导出表  heavensky2.hs2_terms 的数据：3 rows
/*!40000 ALTER TABLE `hs2_terms` DISABLE KEYS */;
INSERT INTO `hs2_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
	...
	(3, '人物详情', '', 'article', '', 0, 0, '0-3', '', '', '', 'list_person', 'person', 0, 1);
/*!40000 ALTER TABLE `hs2_terms` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_term_relationships 结构
...
-- 正在导出表  heavensky2.hs2_term_relationships 的数据：23 rows
/*!40000 ALTER TABLE `hs2_term_relationships` DISABLE KEYS */;
INSERT INTO `hs2_term_relationships` (`tid`, `object_id`, `term_id`, `listorder`, `status`) VALUES
	...
	(22, 25, 3, 0, 1),
	(23, 26, 3, 0, 1);
/*!40000 ALTER TABLE `hs2_term_relationships` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_users 结构
...
-- 正在导出表  heavensky2.hs2_users 的数据：4 rows
/*!40000 ALTER TABLE `hs2_users` DISABLE KEYS */;
INSERT INTO `hs2_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`) VALUES
	(1, 'root', '###78c4a0bc9677ec556f5b12a2133f516a', 'admin', 'sdygt@users.noreply.github.com', '', NULL, 0, NULL, NULL, '0.0.0.0', '2016-02-28 11:00:08', '2016-01-18 09:59:11', '', 1, 0, 1, 0, ''),
/*!40000 ALTER TABLE `hs2_users` ENABLE KEYS */;


-- 导出  表 heavensky2.hs2_user_favorites 结构
...
-- 正在导出表  heavensky2.hs2_user_favorites 的数据：1 rows
/*!40000 ALTER TABLE `hs2_user_favorites` DISABLE KEYS */;
/*!40000 ALTER TABLE `hs2_user_favorites` ENABLE KEYS */;
